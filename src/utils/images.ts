...
const allImages = {
  rhinoArmy: {
    ...
    key: 'rhinoArmy',
    link: 'art/rhino-army',
    alt: 'Rhino Army by Lance Snider',
  },
  verticAlley: {
    image: verticAlley,
    key: 'verticAlley',
    link: 'art/magic-alley',
    alt: 'Magic Alley by Lance Snider',
  },
  blindWolf: {
    image: blindWolf,
    key: 'blindWolf',
    link: 'art/beware-the-blind-wolf',
    alt: 'Beware, the Blind Wolf by Lance Snider',
  },
  kraken: {
    image: kraken,
    key: 'kraken',
    link: 'art/kraken',
    alt: 'Kraken by Lance Snider',
  },
  deadBird: {
    image: deadBird,
    key: 'deadBird',
    link: 'art/dead-bird',
    alt: 'Dead Bird by Lance Snider',
  },
  hermit: {
    image: hermit,
    key: 'hermit',
    link: 'art/hermit',
    alt: 'Hermit by Lance Snider',
  },
  birdsReal: {
    image: birdsReal,
    key: 'birdsReal',
    link: 'art/birds-arent-real',
    alt: "Birds Aren't Real by Lance Snider",
  },
  hogwarts: {
    image: hogwarts,
    key: 'hogwarts',
    link: 'art/hogwarts',
    alt: 'Hogwarts by Lance Snider',
  },
  humpback: {
    image: humpback,
    key: 'humpback',
    link: 'art/humpback',
    alt: 'Humpback by Lance Snider',
  },
  sasquatch: {
    image: sasquatch,
    key: 'sasquatch',
    link: 'art/sasquatch',
    alt: 'Sasquatch by Lance Snider',
  },
  glassOrca: {
    image: glassOrca,
    key: 'glassOrca',
    link: 'art/glass-orca',
    alt: 'Glass Orca by Lance Snider',
  },
  capitolRiot: {
    image: capitolRiot,
    key: 'capitolRiot',
    link: 'art/capitol-riot',
    alt: 'Capitol Riot by Lance Snider',
  },
  octopusCave: {
    image: octopusCave,
    key: 'octopusCave',
    link: 'art/octopus-cave',
    alt: 'Octopus Cave by Lance Snider',
  },
  octopusCharcoal: {
    image: octopusCharcoal,
    key: 'octopusCharcoal',
    link: 'art/octopus-charcoal',
    alt: 'Octopus Charcoal by Lance Snider',
  },
  octopus: {
    image: octopus,
    key: 'octopus',
    link: 'art/octopus',
    alt: 'Octopus by Lance Snider',
  },
  witch: {
    image: witch,
    key: 'witch',
    link: 'art/witch',
    alt: 'Witch by Lance Snider',
  },
  skeleton: {
    image: skeleton,
    key: 'skeleton',
    link: 'art/skeleton',
    alt: 'Skeleton by Lance Snider',
  },
  crocTeeth: {
    image: crocTeeth,
    key: 'crocTeeth',
    link: 'art/croc-teeth',
    alt: 'Croc Teeth by Lance Snider',
  },
  glinesCanyonDam: {
    image: glinesCanyonDam,
    key: 'glinesCanyonDam',
    link: 'art/glines-canyon-dam-removal',
    alt: 'Glines Canyon Dam Removal by Lance Snider',
  },
  heart: {
    image: heart,
    key: 'dumptruckHeart',
    link: 'art/dumptruck-heart',
    alt: 'Heart by Lance Snider',
  },
  littleFactories: {
    image: littleFactories,
    key: 'littleFactories',
    link: 'art/not-your-little-factories',
    alt: 'Not Your Little Factories by Lance Snider',
  },
  hogwartsBw: {
    image: hogwartsBw,
    key: 'hogwartsBw',
  ...
  zombies: {
    image: zombies,
    key: 'zombies',
    link: 'art/zom-be-gone',
    alt: 'Zom-beGone by Lance Snider',
  },
  orcaExploded: {
    image: orcaExploded,
    key: 'orcaExploded',
    link: 'art/orca-exploded',
    alt: 'Orca Exploded by Lance Snider',
  },
  hiking: {
    image: hiking,
    key: 'hiking',
    link: 'art/hiking',
    alt: 'Hiking by Lance Snider',
  },
}
...
const masonryOrder = [
  [
    [
      allImages.rhinoArmy,
      [allImages.deadBird, allImages.hiking],
      allImages.blindWolf,
      allImages.hermit,
      allImages.hogwarts,
      allImages.orcaExploded,
      [allImages.heart, allImages.littleFactories],
    ],
    [
      ...
      [allImages.skeleton, allImages.octopus],
      allImages.crocTeeth,
      allImages.octopusCave,
      allImages.capitolRiot,
    ],
    [
      [allImages.glassOrca, allImages.glinesCanyonDam],
