...
import './BrokeBot.scss'

const BrokeBot = () => {
  return (
    <div className='brokebot'>
      <div className='robotpage-top-half'>
        <div id='robot_holder' className='robot_holder'>
          <svg
            id='brokebotSVG'
            version='1.1'
          ...
          >
            ...
            <g id='robotHead'>
              <rect
                x='359.2'
                y='173.1'
                className='robot_limbs_and_ears'
                width='6.4'
                height='23.3'
              />
              <rect
              ...
              <g id='eyesMove'>
                <g id='eyesBlink'>
                  <rect
                    x={311}
                    y='210.4'
                    className='robot_eyes'
                    width='12.1'
                    height='12.1'
                  />
                  <polygon
                    className='robot_eyes_highlight'
              ...
              <rect
                ...
                height='9.8'
              />
              <circle className='robot_antenna' cx='362.4' cy='167.9' r={10} />
              <circle
                className='robot_antenna_highlight'
                cx='363.4'
                cy='165.9'
                r='5.5'
              />
      ...
      <div className='robotpage-bottom-half'>
        <p id='robot-text'>Error Bad</p>
